...
Ngày tạo: 19/03/2026 Phiên bản: 1.0 Nhóm thực hiện: [Tên nhóm]
...
6	Google Gemini	Gemini 3.1 Pro	Hỗ trợ chuẩn hóa văn phong học thuật cho Báo cáo cuối kỳ, cấu trúc luận điểm so sánh mô hình (Baseline Comparison) theo chuẩn RBL.	Giai đoạn cuối
...
Báo cáo Đồ án Cuối kỳ (Final Report)	Google Gemini	Tổng hợp số liệu thực nghiệm (Metrics, EDA) do nhóm cung cấp thành các đoạn văn mô tả chuẩn học thuật, xây dựng cấu trúc luận điểm nghiên cứu (RBL).	20%	80%
...
Case 4: Final Report
Bước	Nội dung
Input từ Nhóm	Cung cấp số liệu thô: MAPE 7.11%, RMSE giảm 26.5% so với Baseline MA(3), R² tăng từ 0.30 lên 0.62.
AI Output (Gemini)	Viết thành đoạn văn mô tả sự vượt trội của thuật toán Gradient Boosting so với mô hình cơ sở theo văn phong bài báo khoa học.
Review & Chỉnh sửa	Nhóm đối chiếu lại các chỉ số với kết quả chạy code thực tế trên Jupyter Notebook. Hiệu đính lại các thuật ngữ (như "lag features", "Feature Importance") để sát với bối cảnh dữ liệu hóa đơn Việt Nam.
Kết quả	Văn bản báo cáo đạt chuẩn RBL, minh bạch về số liệu và tiết kiệm thời gian soạn thảo.
________________________________________
...
- "Viết lại đoạn so sánh kết quả giữa Gradient Boosting và Baseline Moving Average thành văn phong học thuật dựa trên các số liệu sau..."

- "Cấu trúc phần mô tả quá trình Khám phá dữ liệu (EDA) và Tiền xử lý (IQR, Missing values) cho báo cáo đồ án Khoa học dữ liệu."
